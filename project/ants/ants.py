...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        place = self.place
        dis = 0
        while place is not beehive and place is not None:
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.is_true_queen == False:
    ...
    def action(self, gamestate):
        ...
        if self.is_true_queen:
            ...
            while place is not None:
                if place.ant is not None and place.ant.doubled == False:
...
class ContainerAnt(Ant):
    ...
    def contain_ant(self, ant):
        # BEGIN Problem Optional 2
        "*** YOUR CODE HERE ***"
        if self.can_contain(ant) and self.contained_ant is None:
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        rel_damage = self.damage - 0.2 * distance - 0.05 * self.insects_shot
        return rel_damage if rel_damage > 0 else 0
        # END Problem Optional 5
